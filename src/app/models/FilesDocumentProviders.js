    ...
    super.init(
      {
        ...
        url: {
          ...
          get() {
            return `http://192.168.2.100:21046/files/${this.path}`;
          },
        },
        ...
        url_verse: {
          type: Sequelize.VIRTUAL,
          get() {
            return `http://192.168.2.100:21046/files/${this.path_verse}`;
          },
        },
        ...
        url_your: {
          type: Sequelize.VIRTUAL,
          get() {
            return `http://192.168.2.100:21046/files/${this.path_your}`;
          },
        },
      },
      {
