    ...
    super.init(
      {
        ...
        url_verse: {
          type: Sequelize.VIRTUAL,
          get() {
            return `http://knowledgesoftware.kinghost.net:21046:21046/files/${this.path_verse}`;
          },
        },
        ...
        url_your: {
          type: Sequelize.VIRTUAL,
          get() {
            return `http://knowledgesoftware.kinghost.net:21046:21046/files/${this.path_your}`;
          },
        },
      },
      {
